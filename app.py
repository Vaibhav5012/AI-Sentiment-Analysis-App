...
def scrape_and_save_to_csv(url):
    try:
        ...
        chrome_options.add_argument("--disable-webgl")  # Add this line
        chrome_options.add_argument("--ignore-gpu-blocklist")  # Add this line
    ...
    try:
        ...
        if "Text" in df.columns:
            ...
            wordcloud = WordCloud(width=500, height=800, background_color="white",
                                  stopwords=stopwords, max_words=600, colormap='viridis').generate(text_data)
